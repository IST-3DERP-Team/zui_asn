		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#zuiasnzuiasn-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zuiasnzuiasn-display": {
								"semanticObject": "zuiasnzuiasn",
								"action": "display",
								"description": "Advance Shipment Notice App",
								"title": "Advanced Shipment Notice",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zuiasn.zuiasn",
									"url": sap.ui.require.toUrl("zuiasn/zuiasn")
								}
							}
						}
					}
